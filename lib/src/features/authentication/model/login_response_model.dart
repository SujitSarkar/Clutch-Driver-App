...
class User {
  final Info? info;
  final dynamic thisRoutePermission;
  final dynamic thisRouteName;
  final Roles? roles;
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    thisRoutePermission: json["this_route_permission"],
    thisRouteName: json["this_route_name"],
  ...
  Map<String, dynamic> toJson() => {
    "info": info?.toJson(),
    "this_route_permission": thisRoutePermission,
    "this_route_name": thisRouteName,
    "roles": roles?.toJson(),
...
class Company {
  ...
  final dynamic orgKey;
  final dynamic orgAbn;
  final dynamic orgEmail;
  final dynamic orgPhone;
  final dynamic orgAddress;
  final int? isActive;
  ...
  final dynamic companyKey;
  final dynamic companyAbn;
  final dynamic companyEmail;
  final dynamic companyPhone;
  final dynamic companyAddress;
  final int? organizationId;
  final dynamic xeroAuthToken;
  final dynamic companyManagement;
  final int? companyId;
  final dynamic xeroTenantAccessToken;
  final dynamic xeroTenantId;
  final dynamic xeroTenantName;
  final dynamic xeroTenantType;
  final List<dynamic>? routePermissions;
